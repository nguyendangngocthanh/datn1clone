                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="shop__product__option__left">
                                <p>Showing {{ $productList->firstItem() }}–{{ $productList->lastItem() }} of {{ $productList->total() }} results</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="shop__product__option__right">
                                ...
                                <select>
                                    ...
                                    <option value="">0 - 150.000 VNĐ</option>
                                    <option value="">150.000 - trở lên </option>
                                </select>
                            </div>
                        </div>
                    </div>
